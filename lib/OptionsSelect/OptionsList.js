...
var OptionsList = function (_Component) {
  ...
  function OptionsList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OptionsList.__proto__ || Object.getPrototypeOf(OptionsList)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (_ref2, checked) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Form.FormControlLabel, {
          label: getLabel(item),
          control: _react2.default.createElement(ItemComponent, {
            value: item.id,
            name: name,
...
OptionsList.defaultProps = {
  ...
  getLabel: function getLabel(_ref5) {
    var name = _ref5.name,
        title = _ref5.title,
        label = _ref5.label,
        displayName = _ref5.displayName;
    return displayName || label || name || title;
  }
};
